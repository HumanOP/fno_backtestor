...
def html(
    ...
    **kwargs,
    ...
    if trade_stats is not None:
        ...
        print("Filtered trade_stats_df:", trade_stats_df)  # Debug statement
    ...
    if trade_table is not None:
        ...
        for col in ["EntryPrice", "ExitPrice", "PnL", "ReturnPct"]:
            if col in trade_table.columns:
                trade_table[col] = trade_table[col].round(2)
        trade_table_html = f"""
        <h3>Trade Details</h3>
    ...
    # Now add equity_df below trade details
    if equity_df is not None:
        equity_df = equity_df.copy()
        # You can format equity_df as needed here, e.g., round or convert columns
        equity_html = f"""
        <h3>Equity Curve</h3>
