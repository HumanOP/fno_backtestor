...
class FixedLossPositionSizing:
    ...
    def size(self) -> int:
        ...
        Update: Passing the maximum of all four leg * 4 as margin

        As position size would be cash*max_loss_percentage/maximum of 4 contracts
        """
        ...
        # position_size = max_loss_dollars # for simplicity
